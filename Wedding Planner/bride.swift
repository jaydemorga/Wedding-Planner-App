...
struct bride: View {
    ...
    @State private var items: [String] = (UserDefaults.standard.array(forKey: "brideToDoList") as? [String] ?? ["Buy Dress"])
    @State private var isCompleteList: [Bool] = (UserDefaults.standard.array(forKey: "brideIsCompleteList") as? [Bool] ?? [false])
    ...
    private var isCompleteKey = "brideIsCompleteList"
    private var key = "brideToDoList"
    var body: some View {
        ZStack{
            VStack{
                Text("Bride's To Do:")
